...
#define OMAP_PACKAGE_ZCN		9		/* 491-pin */
...
/**
 * omap_mux_get_reg - returns the mux register value for a given GPIO
 * @gpio:		GPIO number
 */
int omap_mux_get_reg(int gpio);

/**
 * omap_mux_clear_reg - clears a mux value
 * @gpio:		GPIO number
 */
int omap_mux_clear_reg(int gpio);
