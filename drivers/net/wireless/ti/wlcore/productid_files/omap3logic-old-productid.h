...
#ifndef __OMAP3LOGIC_OLD_PRODUCTID_H__
#define __OMAP3LOGIC_OLD_PRODUCTID_H__
...
extern int omap3logic_fetch_old_sram_product_id_data(void);
...
extern int __init omap3logic_fetch_old_production_data(void);
